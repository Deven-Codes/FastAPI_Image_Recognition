...
async def create_upload_files(files: List[UploadFile] = File(...)):
    ...
    content = head_html + """
    <marquee width="525" behavior="alternate"><h1 style="color:red;font-family:Arial">Here is our predictions!</h1></marquee>
...
async def main():
    ...
    <br/>
    <br/>
    <form  action="/uploadfiles/" enctype="multipart/form-data" method="post" style="color:white">
...
def get_html_table(image_paths, names, column_labels):
    ...
    for name, image_path in zip(names, image_paths):
        ...
        s += '<td style="text-align:center;color:white">' + name + '</td></tr>'
    s += '</table>'
